...
import { Heart, Shield, Clock, Phone, ArrowRight, Star, CheckCircle2, Users, Briefcase, Activity, ChevronRight } from "lucide-react";
    ...
    const services = [
        {
            ...
            description: "World-class care for your little ones. Our verified nannies bring love, safety, and expertise to your home.",
            icon: Heart,
            color: "bg-rose-500",
        ...
        },
        {
            ...
            description: "Compassionate companionship and specialized assistance for seniors. We prioritize dignity and comfort.",
            icon: Users,
            color: "bg-teal-500",
        ...
        {
            id: "sick-care",
            title: "Expert Patient Care",
            description: "Dedicated medical support for recovering patients. Professional caregivers trained for health and recovery.",
            icon: Activity,
            color: "bg-blue-600",
        ...
        <div className="flex flex-col gap-0 overflow-hidden font-inter">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <p className="max-w-xl text-xl text-slate-600 mb-10 leading-relaxed font-inter">
                                Experience premium home caregiving services tailored to your family's needs. Safe, reliable, and verified experts just a click away.
                            </p>
                                ...
                                <div className="absolute bottom-8 left-8 right-8 bg-white/10 backdrop-blur-xl p-6 rounded-2xl border border-white/20">
                                    <div className="flex items-center gap-4 text-white">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-sm opacity-80">Based on 2.4k reviews</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="bg-slate-50 py-12 border-y border-slate-100">
                <div className="max-w-7xl mx-auto px-4 flex flex-wrap justify-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                    <span className="text-xl font-bold text-slate-400 font-heading">HEALTH PARTNER</span>
                    <span className="text-xl font-bold text-slate-400 font-heading">TRUST CARE</span>
                    <span className="text-xl font-bold text-slate-400 font-heading">SAFE HOME</span>
                    <span className="text-xl font-bold text-slate-400 font-heading">MEDICLIFE</span>
                    <span className="text-xl font-bold text-slate-400 font-heading">FAMILY FIRST</span>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                        <div className="max-w-2xl">
                            <h2 className="text-sm font-bold tracking-widest text-teal-600 uppercase mb-4 px-1">Specialized Solutions</h2>
                            <h3 className="text-4xl md:text-5xl font-bold text-slate-900 font-heading">Comprehensive Care for Every Stage of Life</h3>
                        </div>
                        <Link href="/services" className="text-slate-900 font-bold border-b-2 border-slate-900 pb-1 hover:text-teal-600 hover:border-teal-600 transition-all flex items-center gap-2">
                        ...
                        {services.map((service) => (
                            ...
                            >
                                ...
                                <div className="px-6 pb-8">
                                    <div className={`w-14 h-14 ${service.color} text-white rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-teal-500/10`}>
            ...
            <section className="py-32 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div>
                            <h2 className="text-sm font-bold tracking-widest text-teal-400 uppercase mb-4">Our Commitment</h2>
                            <h3 className="text-4xl md:text-5xl font-bold mb-10 font-heading leading-tight">Setting the Standard for Premium Care</h3>

                            <div className="space-y-8">
                                {[
                                    { title: "Rigorous Verification", desc: "Every caregiver undergoes extensive background checks and health screenings.", icon: Shield },
                                    { title: "Personalized Matching", desc: "We match caregivers based on medical needs, personality, and lifestyle.", icon: Users },
                                    { title: "24/7 Priority Support", desc: "Our care coordinators are available around the clock for total peace of mind.", icon: Clock },
                                    { title: "Seamless Digital Experience", desc: "Easy booking, real-time tracking, and automated payments via Stripe.", icon: Activity },
                                ].map((feature, i) => (
                                    <motion.div
                                        key={i}
                        ...
                        <div className="relative">
                            <div className="relative z-10 p-2 bg-white/5 rounded-[3rem] border border-white/10 backdrop-blur-sm overflow-hidden">
                                <img src="file:///C:/Users/imtia/.gemini/antigravity/brain/047017b1-f27d-4af0-9fa8-b04277ad8175/hero_caregiving_premium_1766915280039.png" alt="Care Expert" className="rounded-[2.5rem] w-full shadow-2xl" />
                            </div>
            ...
            <section className="py-32 bg-white">
                <div className="max-w-5xl mx-auto px-4">
                    <div className="bg-gradient-to-br from-teal-600 to-blue-700 rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl" />

                        <h2 className="text-4xl md:text-5xl font-bold mb-8 font-heading">Ready to find the perfect care for your family?</h2>
                        <p className="text-xl opacity-90 mb-12 max-w-2xl mx-auto">
                            Join thousands of happy families who trust Care.xyz for their home care needs. Schedule your first session in less than 5 minutes.
                        </p>
