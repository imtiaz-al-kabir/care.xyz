    ...
    return (
        <div className="space-y-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h1 className="text-4xl font-bold text-slate-900 font-heading tracking-tight mb-2">Executive Overview</h1>
                    <p className="text-slate-500 font-medium">Real-time clinical and financial performance metrics</p>
                </div>
                ...
                {statCards.map((stat, index) => (
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-4xl font-bold text-slate-900 font-heading">{stat.value}</p>
                        </div>
                    </motion.div>
                ))}
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                >
                    <div className="flex justify-between items-center mb-10">
                        ...
                        <button className="text-sm font-bold text-teal-600 hover:text-teal-700 transition-colors">Generate Report</button>
                    </div>
                        ...
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="flex items-center justify-between group cursor-pointer">
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        <p className="text-slate-900 font-bold">New Booking Request</p>
                                        <p className="text-slate-400 text-sm">Gulshan, Dhaka • Premium Baby Care</p>
                                    </div>
                                </div>
                ...
                >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                        <div className="mb-10">
                            <h2 className="text-2xl font-bold font-heading mb-2">Network Status</h2>
                            <p className="text-teal-400 text-sm font-bold uppercase tracking-widest">Operational • 99.9% Uptime</p>
                        </div>

                        <div className="space-y-8 flex-grow">
                            <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
                                <p className="text-white/60 text-xs font-bold uppercase tracking-widest mb-2">Database Cluster</p>
