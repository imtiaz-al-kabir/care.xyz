        ...
        <div className="flex flex-col h-full">
            ...
            <nav className="flex-grow px-4 mt-4 space-y-2">
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            <item.icon size={22} className={`shrink-0 ${isActive ? "text-teal-400" : "group-hover:text-teal-600 transition-colors"}`} />
                            {(isSidebarOpen || isMobile) && (
                                <motion.span
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
            ...
            <div className="p-6 border-t border-slate-100">
                ...
                >
                    ...
                    {(isSidebarOpen || isMobile) && <span className="text-sm font-bold">Exit Portal</span>}
                </button>
            </div>
        </div>
    );
                ...
                <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-100 px-8 flex items-center justify-between sticky top-0 z-40">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="hidden sm:flex flex-col items-end">
                            ...
                            <span className="text-[10px] text-teal-600 font-bold uppercase tracking-wider">Super Administrator</span>
                        </div>
